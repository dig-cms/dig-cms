...
export interface DigPluginContext<T> {
  $implicit: T;
  digPlugin: T;
}
...
export class DigPluginDirective<T> implements OnDestroy, OnInit {
  ...
  constructor(
    ...
    private nextRef: TemplateRef<DigPluginContext<T>>,
